...
export default function Header({
    ...
    // call data course of user
    return (
        <div className="bg-white pt-[48px] flex justify-between border-b border-[#F1F1F1] pb-[35px] relative">
                ...
                <div className="flex border-l border-[#F1F1F1] gap-x-[50px]">
                    <div className="flex pl-[55px] gap-x-[12px] items-center">
                        ...
                        <svg
                            ...
                            strokeWidth="1.5"
                            stroke="currentColor"
                            className="size-7 bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text text-transparent"
                        >
                            <path
                                strokeLinecap="round"
                        ...
                        <div className="flex flex-col justify-between">
                            <h3
                                className="font-medium text-[#080808]"
                                onClick={handleDisplay}
                            >
                                {typeof store.result === "string"
                                    ? "LogIn"
                                    : !store?.name
                                    ? "Log In"
                                    : store.name}
                            ...
                            <h3
                                className="font-medium text-[#08080880]"
